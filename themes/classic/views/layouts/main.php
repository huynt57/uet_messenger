...
<body>
        ...
        <div id="navigation">
			<div class="container-fluid">
				...
				<ul class='main-nav'>
					<li <?php if(empty($this->navigationSelectedIndex)  || $this->navigationSelectedIndex == Yii::app()->params['NAV_DASHBOARD_INDEX']){echo "class='active'";} ?>>
						<a href="<?php echo Yii::app()->createUrl('dashboard');?>">
							<span><?php echo Yii::t(Yii::app()->params['TRANSLATE_FILE'],'Dashboard');?></span>
						</a>
					</li>
					<li <?php if(!empty($this->navigationSelectedIndex) && $this->navigationSelectedIndex == Yii::app()->params['NAV_USER_MANAGER_INDEX']){echo "class='active'";} ?>>
			...
			<div id="main">
				<div class="container-fluid">
					<div class="page-header">
						<div class="pull-left">
							<h1><?php if(!empty($this->headerTitle)) echo $this->headerTitle; else echo Yii::app()->params['SITE_NAME'] ?></h1>
						</div>
